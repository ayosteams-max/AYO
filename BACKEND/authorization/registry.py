...
PERMISSION_REGISTRY = MappingProxyType(
    {
        ...
        "eat.availability.manage": "Manage PRE-PRODUCTION P2 Eat availability policies.",
        ...
        "merchant_orders.admit_decision": "Admit PRE-PRODUCTION merchant decision cases.",
        "merchant_orders.expire_decisions": "Expire due PRE-PRODUCTION merchant decision cases.",
        ...
        "courier_dispatch.admit": "Admit valid Preparation readiness evidence into PRE-PRODUCTION Courier Dispatch.",
        "courier_dispatch.manage": "Manage PRE-PRODUCTION courier offers, assignment recovery, cancellation and unfulfilled outcomes.",
